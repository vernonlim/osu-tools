    ...
    public partial class ObjectDifficultyValuesContainer : Container
    {
        ...
        private void drawCatchValues(CatchDifficultyHitObject hitObject)
        {
            flowContainer.AddRange(new[]
            {
                ...
                new ObjectInspectorDifficultyValue("SpeedType", hitObject.DisplayData.SpeedType.ToString()),
                new ObjectInspectorDifficultyValue("Speed", hitObject.DisplayData.NoteSpeed),
                ...
                new ObjectInspectorDifficultyValue("PLSR", hitObject.DisplayData.PartialLocalStarRating),
                new ObjectInspectorDifficultyValue("LSR", hitObject.DisplayData.LocalStarRating),
                ...
                new ObjectInspectorDifficultyValue("Catcher Width", hitObject.DisplayData.CatcherWidth),
                ...
                new ObjectInspectorDifficultyValue("Standing Width", hitObject.DisplayData.CatcherStandingWidth),
                ...
                new ObjectInspectorDifficultyValue("S.Direction", hitObject.DisplayData.SignificantMovementDirection.ToString()),
                new ObjectInspectorDifficultyValue("Left Note Border", hitObject.Borders.Left),
                new ObjectInspectorDifficultyValue("Right Note Border", hitObject.Borders.Right),
